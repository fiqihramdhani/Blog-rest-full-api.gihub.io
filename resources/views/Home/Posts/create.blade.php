        ...
        <div class="col-lg-6">
            <form action="/Dashboard/Home/Posts" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control  @error('T_Home') is-invalid @enderror " id="title"
                        name="T_Home" autofocus value="{{ old('T_Home') }}" required>
                    @error('T_Home')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('J_Home') is-invalid @enderror" id="judul-posting"
                            name="J_Home" value="{{ old('J_Home') }}" required>
                        @error('J_Home')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
