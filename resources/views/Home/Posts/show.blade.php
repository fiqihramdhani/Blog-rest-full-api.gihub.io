        ...
        <div class="w3-row">
            ...
            <div class="w3-col l8 s12">
                ...
                <div class="w3-card-4 w3-margin w3-white">
                    ...
                    @else
                        <img src="https://source.unsplash.com/1200x500?{{ $Post->J_Home }}" alt="Nature" style="width:100%"
                            class="mb-3">
                    @endif
                    ...
                    <div class="w3-container mb-3 ">
                        ...
                        <p><a href="/?Category={{ $Post->Category->slug }}">{{ $Post->Category->Nama }}</a></p>
                    ...
                    <div class="w3-container " style="text-align: justify">
                        ...
                        <div class="w3-row mt-5 ">
                            <div class="w3-col m8 s12">
                                <p><a button class="w3-button w3-red  w3-padding-large w3-white "
                                        href="/Dashboard/Home/Posts">
                                        <a href="http://web-app.test/Dashboard/Home-Posts" class="btn btn-primary"><b>Back
                                                to My Posts</b></a>
                            </div>
                        </div>
                    </div>
