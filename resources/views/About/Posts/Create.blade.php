...
@section('content')
    ...
    <div class="container">
        <div class="col-lg-6">
            <form action="/Dashboard/About/Posts" method="post" enctype="multipart/form-data">
                @csrf
                <div class="mb-3">
                        ...
                        <select class="form-select @error('category_id') is-invalid @enderror" name="category_id">
                            ...
                            @foreach ($Category as $Categories)
                                @if (old('category_id') == $Categories->id)
                                    <option value="{{ $Categories->id }}" selected>{{ $Categories->Nama }}</option>
                                @else
                    ...
                    <div class="mb-3">
                        ...
                        <input id="body" type="hidden" name="Deskripsi" value="{{ old('Deskripsi') }}">
